...
from _42labs.cavendish.prelude import cavendish
...
func test_ndtri3{range_check_ptr}():
    ...
    let (z1) = cavendish.ndtri(2075258708292324608)  # 0.9
    let (z2) = cavendish.ndtri(230584300921369408)  # 0.1
    assert z1 + z2 = 0
